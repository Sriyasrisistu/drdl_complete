...
-- 5. Supervisor approver accounts
INSERT INTO APPROVER_USERS (LOGIN_ID, PASSWORD, APPROVER_NAME, DESIGNATION, ROLE_CODE, STATUS) VALUES
...
SELECT LOGIN_ID, APPROVER_NAME, ROLE_CODE, STATUS FROM APPROVER_USERS;
